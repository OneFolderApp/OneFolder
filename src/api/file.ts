...
export type FileDTO = {
  ...
  absolutePath: string;
  tags: ID[];
  /** When the file was imported into OneFolder */
  dateAdded: Date;
  /** When the file was modified in OneFolder, not related to OS modified date */
  dateModified: Date;
  /**
   * When the file was last indexed in OneFolder: concerning the metadata and thumbnail.
