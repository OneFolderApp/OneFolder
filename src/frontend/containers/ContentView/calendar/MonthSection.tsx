...
export const MonthSection = observer(
  ({ group, containerWidth, onPhotoSelect, focusedPhotoId }: MonthSectionProps) => {
    ...
    const photosPerRow = useMemo(
      () => Math.floor((containerWidth - 32) / (thumbnailSize + 4)), // 32px total padding, 4px gap
